    ...
    fun hookGetBlurryLocationS(lpparam: XC_LoadPackage.LoadPackageParam) {
            ...
            if (ConfigGateway.get().inWhitelist(packageName)) {
                ...
                if (locationResult != null) {
                    ...
                    for (i in 0 until size) {
                        ...
                        originLocation.latitude = fakeLocation.x + (Math.random() * fakeLocation.x_bais - fakeLocation.x_bais / 2)
                        originLocation.longitude = fakeLocation.y + (Math.random() * fakeLocation.y_bais - fakeLocation.y_bais / 2)
        ...
        findAllMethods(clazz) {
            ...
            if (ConfigGateway.get().inWhitelist(packageName)) {
                ...
                location.latitude = fakeLocation.x + (Math.random() * fakeLocation.x_bais - fakeLocation.x_bais / 2)
                location.longitude = fakeLocation.y + (Math.random() * fakeLocation.y_bais - fakeLocation.y_bais / 2)
